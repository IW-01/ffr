...
<body>
  <header>
	...
	<section id="left-sidebar">
		...
		<p>Nam et vestibulum elit, eu vestibulum ante. Vivamus dapibus leo vel hendrerit euismod.
		Nullam pretium augue in lorem consequat, suscipit cursus eros ultricies. Aliquam gravida 
		accumsan condimentum. Fusce viverra ante a ornare semper. Aliquam erat volutpat. Vivamus 
		porttitor bibendum lacus ut pellentesque. Integer malesuada ipsum ut dolor congue ornare. 
		Vivamus aliquam gravida congue. Mauris orci ligula, ornare et commodo nec, aliquet et nibh. 
		Ut non velit at nisl tempus consectetur suscipit vel dui</p>
	</section>
	<section id="main">
		<h2>Main</h2>
	...
	<section id="right-sidebar">
		...
		<article>
			...
			<iframe src="http://www.physioroom.com/affiliate/common/syndicate_table2_mini.php?w=270" width="290" height="2000" frameborder="0"></iframe>
